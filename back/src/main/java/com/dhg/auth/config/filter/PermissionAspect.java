package com.dhg.auth.config.filter;

import com.dhg.auth.config.annotation.Logical;
import com.dhg.auth.config.annotation.RequiresPermissions;
import com.dhg.auth.config.exception.UnauthorizedException;
import com.dhg.auth.dto.session.SessionUserInfo;
import com.dhg.auth.service.TokenService;
...
public class PermissionAspect {
    ...
    @Before("@annotation(com.dhg.auth.config.annotation.RequiresPermissions)")
